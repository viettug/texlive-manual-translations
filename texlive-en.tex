...
\file{.../2014/texmf.cnf}.  If you must make changes to the defaults
(not normally necessary), this is the place to put them.  The main
configuration file is in \file{.../2014/texmf-dist/web2c/texmf.cnf}.
...
\url{http://tug.org/TUGboat/34-1/tb106scarso.pdf}).  \code{luajittex} is
...
Microsoft no longer supports Windows XP, so our programs may start
failing there at any time.
