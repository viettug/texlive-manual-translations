...
\title{%
  {\huge \textit{The \TeX\ Live Guide---2018}}
}
...
\begin{center}
This year's \TeX\ Live is dedicated to our sadly departed colleague
...
\begin{description}
  ...
  \begin{ttdescription}
    \item[2017] A previous release.
    \item[2018] The current release.
    \begin{ttdescription}
      \item [bin] ~
      \begin{ttdescription}
...
\dirname{/usr/local/texlive/2018} on Unix and
|%SystemDrive%\texlive\2018| on Windows.  This arrangement enables
...
\file{.../2018/texmf.cnf}.  If you must make changes to the defaults
(not normally necessary), this is the place to put them.  The main
configuration file is in \file{.../2018/texmf-dist/web2c/texmf.cnf}.
...

\htmlanchor{news}
\subsection{Present---2018}
\label{sec:tlcurrent}

ep\TeX, eup\TeX: New primitive \cs{epTeXversion}.

Lua\TeX: Preparation for moving to Lua\TeX\ 5.3 in 2019: a binary
